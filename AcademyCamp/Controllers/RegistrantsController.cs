...
namespace AcademyCamp.Controllers
{
    ...
    public class RegistrantsController : Controller
    {
        ...
        //Called from populateWorkshops Javascript. Populates Workshop dropdownlist from Json Object
        ...
        // GET: Sortable and Searchable Registrants
        public async Task<ActionResult> Index(string sortOrder, string searchString, string filterString)
        {
            ...
            //Create queryable registrant dataset instance for search and sort
            var registrants = db.Registrants.Select(m => m);
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Event,FirstName,LastName,Email,Age,Gender,Tsize,Workshop,SubmitDate,SubmitterId")] Registrant registrant)
        {
            ...
            {
                //Add User ID and Date/Time to registrant object
